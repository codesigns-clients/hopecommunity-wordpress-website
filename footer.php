		...
		<div class="container-fluid container-xxl">
			...
			<div class="card card--transparent mb-4 p-4 d-sm-flex flex-sm-row justify-content-sm-between align-items-sm-center footer-brand text-center text-sm-left">
				...
				<div class="footer-contact ">
					...
					<div class="py-3 d-flex justify-content-center justify-content-sm-start">
			...
			<div class="card card--transparent mb-4 p-4 footer-social text-center text-md-left">
			...
			<div class="card card--transparent mb-4 p-4 footer-menu">
				<div class="row">
					<ul class="col-12 footer-site-links list-unstyled d-md-flex justify-content-md-between mb-0 text-center text-md-left">
			...
			<div class="card card--transparent text-center p-4 footer-copyright">
